...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextMeshPro.rectTransform, Input.mousePosition, UCamera.main))
            {
            ...
            if (m_isHoveringObject)
            {
                ...
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, Input.mousePosition, UCamera.main, true);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextMeshPro, Input.mousePosition, UCamera.main);
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    wordPOS = UCamera.main.WorldToScreenPoint(wordPOS);
